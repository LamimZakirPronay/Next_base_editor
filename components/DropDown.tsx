...
import { productType, roomType, themeType } from "../utils/dropdownTypes";
...
interface DropDownProps {
  theme: themeType | roomType | productType ;
  setTheme: (theme: themeType | roomType | productType) => void;
  themes: themeType[] | roomType[] | productType[];
}
